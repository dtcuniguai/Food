...
public class Advanced_search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adap_type.setDropDownViewResource(R.layout.spinner_dropdown);
        ...
        Button nextPageBtn2 = (Button)findViewById(R.id.advance_search);
        nextPageBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Advanced_search.this , search_list.class);
    ...
    private void initui(){
        type = (Spinner) findViewById(R.id.res_type);
    ...
    AdapterView.OnItemSelectedListener spinnerlistener = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView adapterView, View view,int position, long id) {  //當選取的spinner是kind時
            if (adapterView.getId() == R.id.city) {//判斷選取的種類是何種，設定相對應的字串陣列內容
                ...
                if(showtoast!=false)
                {
                    Toast.makeText(Advanced_search.this,
                            "您選擇" + adapterView.getSelectedItem().toString(),
                            Toast.LENGTH_LONG).show();
                    res_district = adapterView.getSelectedItem().toString();
                }
                showtoast=true;
            }
        }
    ...
    private void setnameitem() {
        showtoast=false;
        ArrayAdapter<String> adap_district = new ArrayAdapter<String>(this, R.layout.spinner_dropdown,
                itemname);
